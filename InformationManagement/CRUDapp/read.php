    ...
    <div class="container">
        ...
        <form method="GET" action="" class="filter-bar">
            ...
            <div>
                ...
                <select name="sort_field">
                    <option value="stud_no" <?php if (isset($_GET['sort_field']) && $_GET['sort_field'] == 'stud_no') echo 'selected'; ?>>Student No</option>
                    <option value="lastname" <?php if (isset($_GET['sort_field']) && $_GET['sort_field'] == 'lastname') echo 'selected'; ?>>Last Name</option>
                    <option value="firstname" <?php if (isset($_GET['sort_field']) && $_GET['sort_field'] == 'firstname') echo 'selected'; ?>>First Name</option>
                    <option value="sex" <?php if (isset($_GET['sort_field']) && $_GET['sort_field'] == 'sex') echo 'selected'; ?>>Sex</option>
                    <option value="bdate" <?php if (isset($_GET['sort_field']) && $_GET['sort_field'] == 'bdate') echo 'selected'; ?>>Birth Date</option>
                    <option value="age" <?php if (isset($_GET['sort_field']) && $_GET['sort_field'] == 'age') echo 'selected'; ?>>Age</option>
                    <option value="religion" <?php if (isset($_GET['sort_field']) && $_GET['sort_field'] == 'religion') echo 'selected'; ?>>Religion</option>
                    <option value="talent" <?php if (isset($_GET['sort_field']) && $_GET['sort_field'] == 'talent') echo 'selected'; ?>>Talent</option>
                </select>
            </div>
            <div>
                <label>Order:</label>
        ...
        <div class="table-responsive">
            <table>
                ...
                $valid_sort_fields = ['stud_no', 'lastname', 'firstname', 'sex', 'bdate', 'age', 'religion', 'talent'];
